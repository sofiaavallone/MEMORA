...
function Mainbar(prop:mainbar){
    ...
    return(
      <div className="mainbar">
        ...
        <div className="centering_div">{/*div para estilização*/}
          <UploadBox //caixa onde se dá o upload dos arquivos
                     //precisará receber a função de setar o array de decks
          />
          ...
          <DeckDisplay state={prop.state} //variável que diz o estdo atual
                        change={prop.change}//função para mudar o estado atual
  ...
  else if (prop.state=="deckpage"){//          estado de deckpage
